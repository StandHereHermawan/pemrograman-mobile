...
class DeliveryCustomerCard extends StatelessWidget {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Timestamps Logic
                      if (isReceived)
                        Text("Diterima: ${delivery.receivedAt}",
                            style: const TextStyle(
                                fontSize: 10, color: Colors.grey))
                      else if (isDelivering)
                        Text("Dikirim: ${delivery.onDeliveryAt}",
                            style: const TextStyle(
                                fontSize: 10, color: Colors.blue))
                      else
                        Text("Dibuat: ${delivery.createdAt}",
                            style: const TextStyle(
                                fontSize: 10, color: Colors.grey)),
                    ],
                  ),
