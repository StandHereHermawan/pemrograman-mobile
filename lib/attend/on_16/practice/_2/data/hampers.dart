import 'package:pemprograman_mobile/attend/on_16/practice/_2/data/helper/hampers_product.dart';
...
class Hampers {
  ...
  final List<HampersProduct> idHampersWithQuantityCollection;
  final int price;
  ...
  const Hampers({
    ...
    this.idHampersWithQuantityCollection = const <HampersProduct>[HampersProduct()],
    this.price = 0,
  ...
  Hampers.fromJson(Map<String, dynamic>? jsonObject)
      : this(
          ...
          idHampersWithQuantityCollection: jsonObject?[''] as List<HampersProduct>
        );
