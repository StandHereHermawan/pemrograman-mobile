...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String titleAppBar = 'Gambar Dari Internet.';
    const String textBodyInsideContainer =
        'Pastikan Gambar ada dan tersedia di internet';
          ...
          body: Column(
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Image.network(
                      "https://www.londonmiddlebury.com/hs-fs/hubfs/Google%20Logo%20Evolution%20LM%20%283%29.png?width=1280&name=Google%20Logo%20Evolution%20LM%20%283%29.png",
                  ),
                ),
              ),
              Container(
